    ...
    <div className='flex flex-col gap-24 pb-20'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-16 items-center'>
          <div className='reveal-anim active flex flex-col gap-8'>
            <h1 className='leading-tight tracking-tight text-neutral-900 dark:text-white'>
              ...
              <span className='text-[#001f3f] dark:text-brand underline decoration-brand/30'>
                without limits
              </span>{' '}
              and <br />
              grow your career
            ...
            <p className='text-neutral-500 text-sm max-w-lg leading-relaxed'>
              Join over 10,000+ students and professionals worldwide learning
              from the best instructors. Get access to premium courses with
          ...
          <div
            className='relative reveal-anim active h-[500px]'
            style={{ transitionDelay: '0.2s' }}
          >
            <div className='absolute inset-0 bg-brand/10 rounded-[100px] transform rotate-6 scale-90 translate-x-10'></div>
            <img
              src={getFullUrl(
                'https://images.unsplash.com/photo-1523240795612-9a054b0db644?w=800&h=1000&fit=crop&q=90'
              )}
              alt='hero'
            ...
            <div className='absolute -bottom-10 -left-10 bg-white dark:bg-neutral-800 p-6 rounded-3xl shadow-2xl z-20 animate-float'>
              <p className='text-[10px] font-black text-[#001f3f] dark:text-brand mb-1'>
                ACTIVE STUDENTS
              </p>
            ...
            <div
              className='absolute top-20 -right-10 glass p-5 rounded-3xl shadow-xl z-20 animate-float'
              style={{ animationDelay: '1s' }}
            >
              <div className='flex items-center gap-3'>
                <div className='w-12 h-12 bg-green-500 rounded-2xl flex items-center justify-center text-[10px] font-black text-white shadow-lg'>
                  TOP
                </div>
                <div>
      ...
      <section className='reveal-anim active'>
        <div className='flex flex-col gap-12'>
          <div className='flex flex-col md:flex-row md:items-end justify-between gap-6'>
            <div>
              <h2 className='font-heading text-neutral-900 dark:text-white'>
                Favorite Courses
              </h2>
            </div>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-4 gap-12 items-start pb-20 border-b border-neutral-100 dark:border-neutral-800'>
            ...
            <div className='lg:col-span-1 filter-sidebar space-y-12'>
              <div className='space-y-6'>
                <p className='text-[11px] font-black uppercase tracking-[0.3em] text-brand-300 opacity-60'>
                  Categories
                </p>
                <div className='flex flex-col gap-3'>
                  {coreCategories.map((cat) => (
                    <button
                      ...
                      className={`px-6 py-3 rounded-2xl text-[11px] font-black uppercase tracking-widest transition-all w-fit text-left ${
                        activeCategory === cat
            ...
            <div className='lg:col-span-3 pt-6'>
              <div className='flex items-center justify-between mb-10'>
                <p className='text-xs font-black uppercase tracking-widest text-neutral-400'>
                  {filteredCourses.length} Learning Paths Found
                </p>
                <div className='flex gap-2'>
                  <button
                    onClick={() => scrollSlider('left')}
                    className='w-10 h-10 rounded-xl border border-neutral-200 dark:border-neutral-700 flex items-center justify-center hover:bg-[#001f3f] hover:text-white transition-all'
                  >
                    ←
                  </button>
                  <button
              ...
              <div ref={sliderRef} className='course-slider gap-6 pb-6'>
                {loading ? (
                  [1, 2, 3].map((i) => (
                    <div
                      key={i}
                      className='min-w-[320px] h-96 bg-neutral-100 dark:bg-neutral-800 rounded-3xl animate-pulse'
                    ></div>
                  ))
                ) : (
                  <>
                    {filteredCourses.length === 0 ? (
                      <div className='w-full py-20 text-center text-neutral-400 italic text-sm'>
      ...
      <section className='reveal-anim active'>
        <div className='card bg-neutral-900 border-none p-12 md:p-20 flex flex-col items-center text-center'>
          <h2 className='text-white max-w-2xl mb-8'>
            Join a community that helps <br /> you grow your real potential
          </h2>
